...
<html lang="en">
  <head>
    ...
    <title>IWM Projects</title>
    <script src="https://cdn.tailwindcss.com"></script>
  </head>

  <body>
    <div class="mt-28 mx-auto max-w-3xl px-4 sm:px-6 md:px-8">
      <div>
        <h2 class="text-lg font-medium text-gray-900">IWM Projects</h2>
        ...
        <ul role="list" class="mt-6 grid grid-cols-1 gap-6 border-t border-b border-gray-200 py-6 sm:grid-cols-2">
              ...
              <div>
                <h3 class="text-sm font-medium text-gray-900">
                  <a href="/login" class="focus:outline-none">
                    ...
                    IWM-SSO<span aria-hidden="true"> &rarr;</span>
                  </a>
                </h3>
          ...
          <li class="flow-root">
            <div class="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 hover:bg-gray-50">
              ...
              <div>
                <h3 class="text-sm font-medium text-gray-900">
                  <a href="http://192.168.1.40:81" class="focus:outline-none">
                    <span class="absolute inset-0" aria-hidden="true"></span>
                    Inventory Management<span aria-hidden="true"> &rarr;</span>
                  </a>
                </h3>
